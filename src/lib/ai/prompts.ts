...
تأكد من:
- وجود 3-4 مراحل منطقية تغطي دورة حياة المشروع (ليس أكثر من 4)
- 3-4 مهام لكل مرحلة فقط (ليس أكثر)
- 3-4 معالم رئيسية
- 3-4 مخاطر واقعية مع درجات خطر محسوبة (probability_score × impact_score)
- 3 KPIs قابلة للقياس
- pmbok_processes: 6 عناصر كحد أقصى
- الجدول الزمني يغطي ${durationWeeks} أسبوع بالكامل
- كن موجزاً جداً — كل وصف 12 كلمة كحد أقصى، والسرعة أولوية
- أخرج JSON فقط — لا تكتب أي نص قبله أو بعده
`.trim(),
  };
}
