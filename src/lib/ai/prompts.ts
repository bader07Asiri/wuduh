...
const DOC_GUIDANCE: Partial<Record<DeliverableType, { title: string; sections: string }>> = {
  ...
  resource_plan: {
    title: "خطة الموارد",
    sections: "نظرة عامة على احتياج الموارد (نص)، الأدوار والمسؤوليات (جدول: الدور | العدد | المسؤوليات | نسبة التخصيص)، الموارد المادية والتقنية (قائمة)، خطة اكتساب الفريق (نص)، مصفوفة المسؤوليات RACI (جدول).",
  },
  risk_response: {
