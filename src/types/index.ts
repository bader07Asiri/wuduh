...
export const PLANS = {
  ...
  enterprise: {
    ...
    features: [
      "طبقة إدارة المؤسسة: رؤية كل الأعمال والأقسام",
      "كل عضو منتِج = مقعد احترافي (150/شهر) — المشرفون مجاناً",
      "مشاركة الملفات بين الأعضاء والأقسام",
      "تقارير المحفظة (Portfolio) + API للتكامل",
